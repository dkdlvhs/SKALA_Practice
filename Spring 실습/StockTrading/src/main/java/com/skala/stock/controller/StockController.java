...
public class StockController {
    ...
    @GetMapping("/search")
    @Operation(summary = "주식 검색", description = "종목 코드 또는 종목명으로 주식을 검색합니다")
    public ResponseEntity<List<StockDto>> searchStocks(@RequestParam(name = "keyword", required = false) String keyword) {
