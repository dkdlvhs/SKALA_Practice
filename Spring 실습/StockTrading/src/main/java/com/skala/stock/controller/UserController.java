...
public class UserController {
    ...
    @Operation(summary = "사용자 자산 요약 조회", description = "잔고, 총 자산, 보유 종목 비중 및 수익률 요약 정보를 조회합니다")
    public ResponseEntity<UserAssetSummaryDto> getAssetSummary(@PathVariable("id") Long id) {
        UserAssetSummaryDto summary = userService.getAssetSummary(id);
